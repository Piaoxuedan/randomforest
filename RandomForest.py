...
class RandomForest(object):
    ...
    def getRandomBootstrapSamplesWithReplacement(self, sampleSize):
        ...
        for i in trainingSampleRange[:sampleSize]:   #sampleSize = 28
    ...
    def getSimpleMajorityVoting(self, instance, defaultLabel):
        ...
        #print (predictedClasses[len(predictedClasses)-1][0])
    ...
    def classifyTestData(self, testInstances):
        ...
        """
        find the majority calss of test Sample
        majorityValuesCount = {}
...
randomForestClassifier = RandomForestClassifier("test2.csv", numberOfTrees)
